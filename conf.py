...
BLOG_AUTHOR = "K-State SIGAI"  # (translatable)
BLOG_TITLE = "K-State SIGAI"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://acm-sigai.cs.ksu.edu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ksu-sigai.github.io/"
BLOG_EMAIL = "kstatesigai@gmail.com"
BLOG_DESCRIPTION = "This is the main website for the K-State Artificial Intelligence club."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/pictures/", "Pictures"),
        ("https://orgsync.com/140145/chapter", "Orgsync"),
...
LOGO_URL = '/sigai-white-logo-small-cropped.png'
